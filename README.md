# SHA256---Basics
SHA-256, or Secure Hash Algorithm 256-bit, is a cryptographic hash function that produces a fixed-size 256-bit (32-byte) hash value from input data of any size.
It's widely used in various security applications and protocols, including digital signatures, data integrity verification, and blockchain technology.
SHA-256 is known for its security and resistance to collision attacks. 
...
the main motive behind publishing this algorithm was to create a successor for the SHA one family and it was developed by the NSA as well as the NIST organisation because the SHA-1 family was losing its strength because of brute force attacks.
